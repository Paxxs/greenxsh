...
copy /y NsCopyHook3.dll "%CommonProgramFiles%\NetSarang"
regsvr32 /s "%CommonProgramFiles%\NetSarang\NsCopyHook3.dll"
...
reg add "HKLM\SOFTWARE\NetSarang\Xshell\6" /f /v Company /d "https://github.com/Paxxs/greenxsh"
reg add "HKLM\SOFTWARE\NetSarang\Xshell\6" /f /v UserName /d "Xshell_Paxos"
reg add "HKLM\SOFTWARE\NetSarang\Xshell\6" /f /v Version /d "6.0.0121"
...
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\Xshell.exe" /ve /d "%~DP0Xshell.exe" /f
...
reg add "HKLM\SOFTWARE\NetSarang\Xmanager\6" /f /v Company /d "https://github.com/Paxxs/greenxsh"
reg add "HKLM\SOFTWARE\NetSarang\Xmanager\6" /f /v UserName /d "Xshell_Paxos"
reg add "HKLM\SOFTWARE\NetSarang\Xmanager\6" /f /v Version /d "6.0.0121"
...
copy /y NsCopyHook3.dll "%CommonProgramFiles(x86)%\NetSarang"
regsvr32 /s "%CommonProgramFiles(x86)%\NetSarang\NsCopyHook3.dll"
reg add "HKCU\SOFTWARE\NetSarang\Xshell\6\Personal" /f /v Notified /t REG_DWORD /d "1"
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xshell\6" /f /v Path /d "%~dp0\"
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xshell\6" /f /v Company /d "https://github.com/Paxxs/greenxsh"
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xshell\6" /f /v UserName /d "Xshell_Paxos"
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xshell\6" /f /v Version /d "6.0.0121"
...
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xmanager\6" /f /v Company /d "https://github.com/Paxxs/greenxsh"
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xmanager\6" /f /v UserName /d "Xshell_Paxos"
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xmanager\6" /f /v Version /d "6.0.0119"
